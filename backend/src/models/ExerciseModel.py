...
class ExerciseModel(db.Model):
    ...
    def __init__(self, data, ex_type: ExerciseTypeModel):
        ...
        self.reps = data.get('reps') or ex_type.default_reps
        self.series = data.get('series') or ex_type.default_series
        self.weight = data.get('weight') or ex_type.default_weight
        self.rest = data.get('rest') or ex_type.default_rest
        self.speed = data.get('speed') or ex_type.default_speed
        self.range_of_motion = data.get('range_of_motion') or ex_type.default_range_of_motion
        self.leftarmplate_level = data.get('leftarmplate_level') or ex_type.default_leftarmplate_level
        self.rightarmplate_level = data.get('rightarmplate_level') or ex_type.default_rightarmplate_level
        self.middleplate_level = data.get('middleplate_level') or ex_type.default_middleplate_level
